    ...
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 500px; margin: 0 auto;">
        ...
        <div style="background: #f8fafc; padding: 20px; border: 1px solid #e2e8f0;">
          ...
          <p><strong>From:</strong> ${new Date(fromDate).toLocaleDateString('en-GB', {day:'2-digit',month:'2-digit',year:'numeric'})}</p>
          <p><strong>To:</strong> ${new Date(toDate).toLocaleDateString('en-GB', {day:'2-digit',month:'2-digit',year:'numeric'})}</p>
